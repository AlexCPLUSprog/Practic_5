...
int main() {
	...
	do {
		...
		std::cin >> m;
		switch (m) {
		case 1: std::cout << "\nВведите номер книги(0 - 2) -> "; std::cin >> l; show_book(arr_book[l]);
			continue;
		case 2: std::cout << "\nВведите номер книги(0 - 2), чтобы увидеть фамилию автора -> "; std::cin >> l; std::cout << "Автор " << l + 1 << " книги: " << author_name(arr_book[l]) << "\n\n";
			continue;
		case 3: std::cout << "\nВведите номер книги(0 - 2), чтобы информацию о ней можно было записать в файл -> "; std::cin >> l; save_book(arr_book[l], "file.txt"); std::cout << "Книга успешно записана в файл.\n\n";
			continue;
